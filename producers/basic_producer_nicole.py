...
ACTIONS: list = ["left", "visited", "loved", "hiked in", "camped in"]
PARKS: list = ["Yosemite NP", "Theodore Roosevelt NP", "Grand Canyon NP", "Grand Teton NP", "Bryce Canyon NP"]
